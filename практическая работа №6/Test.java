...
public class Test {
    ...
    public static Student getStudent() {
        ...
        return new Student(random.nextInt(1000), random.nextInt(4)+1, random.nextInt(4)+1, random.nextInt(4)+1, "name"+ (a++), "group"+ (a%4) );
    }
    ...
    public static Student[] mergeSort(Student[] a1, Student[] a2) {
        ...
        for (int k = 0; k < a3.length; k++) {
            ...
            if (i > a1.length - 1) {
                ...
                a3[k] = a;
                i++;
            } else if (a1[i].getKolvo_ballov() < a2[j].getKolvo_ballov()) {
                Student a = a1[i];
                a3[k] = a;
                i++;
            } else {
